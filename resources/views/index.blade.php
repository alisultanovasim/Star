...
<body class="home-blue-color">
    ...
    <div class="main-content">
        ...
        <div class="full-width-header">
            <!--Header Start-->
            <section id="rs-header" class="rs-header header-style1 header-blue-modify2">
                                ...
                                <div class="rs-contact-info">
                                    ...
                                    <div class="contact-part margin-no">
                                        ...
                                        <div class="contact-info">
                                            ...
                                            <div class="info-des">
                                                <a href="tel:+1(201) 456-8806"> +1(201) 456-8806</a>
                                                <br>
                                                <a href="tel:+1(551) 225-5476"> +1(551) 225-5476</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="main-menu">
                                        <nav class="rs-menu hidden-md">
                                            <ul class="nav-menu onepage-menu">
                                                ...
                                                <li><a href="#rs-testimonials">Reviews</a> </li>
                ...
                <nav class="right_menu_togle mobile-navbar-menu" id="mobile-navbar-menu">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li>
                            <a href="#rs-project">Project</a>
                        </li>
                        <li>
                            <a href="#rs-testimonials">Reviews</a>
                        </li>
                        <li>
                        ...
                        <div class="address-area">
                            <div class="address-list">
                                ...
                                <div class="info-content">
                                    ...
                                    <em>08852, New Jersey, USA
                                        <br>
                                        2110 Sugar Maple Ct</em>
                                </div>
                            </div>
                            <div class="address-list">
                                <div class="info-icon">
                                ...
                                <div class="info-content">
                                    ...
                                    <em><a
                                            href="mailto:star.applianceservice.nj@gmail.com">star.applianceservice.nj@gmail.com</a></em>
                                </div>
                            </div>
                            <div class="address-list">
                                <div class="info-icon">
        ...
        <!-- Banner Start -->
        <section id="rs-banner" class="rs-banner banner-style1">
            <div class="banner-background-overlay"></div>
            <div class="container">
                <div class="row y-middle">
                    <div class="col-lg-7">
                        <div class="content-wrap">
                            <span class="sub-text">appliance repair and service</span>
                            <h1 class="title">
                                Repair and service of all model appliances.
                            </h1>
                            ...
                            <div class="banner-btn mt-40">
                                <a class="readon blue-btn" href="#rs-contact">Discover More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 pl-86 md-pl-15 md-pb-140 sm-pb-130 xs-pb-115">
        ...
        <!-- Choose Start -->
        <div class="rs-choose choose-style4">
            <div class="row">
                <div class="col-lg-6">
                    <div class="rs-choose-content">
                        <div class="sec-title mb-45">
                            <span class="sub-text sub-text5">Professional service</span>
                            <h2 class="title">
                                Advantages of us
                            </h2>
                        </div>
                        <div class="rs-addon-services mb-38">
                            <div class="services-icon">
                                <img class="lazy" data-src="assets/images/choose/style2/icons/1.webp" alt="Icons">
                            </div>
                            <div class="services-text">
                                <h4 class="title"> Guaranteed Works</h4>
                                <p class="services-txt">We stand behind the quality of our work and offer a
                                    satisfaction guarantee on all repairs. Our skilled technicians use only high-quality
                                    parts and materials to ensure long-lasting results for your appliance.</p>
                            </div>
                        </div>
                        <div class="rs-addon-services mb-38">
                            <div class="services-icon">
                                <img class="lazy" data-src="assets/images/choose/style2/icons/2.webp" alt="Icons">
                            </div>
                            <div class="services-text">
                                <h4 class="title">Fast Services</h4>
                                <p class="services-txt">We understand the inconvenience of a broken appliance, which is
                                    why we offer fast and efficient repair services to get your appliance up and running
                                    as soon as possible. Same-day appointments are often available.</p>
                            </div>
                        </div>
                        <div class="rs-addon-services">
                            <div class="services-icon">
                                <img class="lazy" data-src="assets/images/choose/style2/icons/3.webp" alt="Icons">
                            </div>
                            <div class="services-text">
                                <h4 class="title">24/7 Emergency Support</h4>
                                <p class="services-txt">We offer 24/7 emergency support for urgent appliance repairs.
                                    Our team is always available to help, even outside of regular business hours. Call
                                    us anytime for fast and reliable service.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 video-item">
                    <div class="rs-videos blue-videos">
                        <div class="animate-border">
                            <a class="popup-border popup-videos" href="assets/video/Untitled.mp4">
        ...
        <!-- About Start -->
        <section id="rs-about" class="rs-about about-style2 pb-150 md-pb-80">
            <div class="container">
                <div class="row y-middle">
                    <div class="col-lg-6 md-mb-50">
                        <div class="widget-img">
                            <img class="lazy" data-src="assets/images/about/style3/electrician.webp" alt="About">
                            <div class="multi-img wow fadeinup">
                                <img style="width: 250px; height: 200px; border: 8px solid #fff;"
                                class="lazy" data-src="assets/images/about/style3/fixing-washing.webp" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 pl-70 md-pl-15 pt-60">
                        <div class="sec-title mb-45 md-mb-25">
                            ...
                            <p class="desc">Welcome to our appliance service company! We offer a wide range of repair
                                ...
                                <br>
                                Our experienced technicians are knowledgeable and skilled in diagnosing and repairing
                                all kinds of appliance issues, from minor faults to major breakdowns. We use only
                                high-quality parts and the latest repair techniques to ensure that your appliances are
                                restored to optimal performance.
                                <br>
                                Our commitment to providing fast, reliable, and affordable service has earned us a
                                reputation as a trusted appliance repair company. We pride ourselves on offering
                                transparent and fair pricing, and we stand behind our work with a satisfaction
                                guarantee.
                                <br>
                                Contact us today to schedule a service appointment and experience the best in appliance
                                repair service!
                            </p>
                        </div>
        ...
        <section id="rs-services" class="rs-process process-style1 bg16 pt-120 pb-115 md-pt-80 md-pb-75">
            <div class="services-background-overlay"></div>
            <div class="container">
                <div class="sec-title text-center mb-45">
                    <span class="sub-text sub-text5 white-color">Our services</span>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 md-mb-30">
                        <div class="services-item">
                            <div class="services-icon">
                                <img class="lazy" data-src="assets/images/process/style1/washing-machine.webp" alt="Images">
                            </div>
                            <div class="content-text">
                                <h4 class="title">Washing machine</h4>
                                <p class="services-txt">Maintenance, repairs, and cleaning to keep washing machines
                                    functional.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 sm-mb-30">
                        <div class="services-item">
                            <div class="services-icon blue-icon-bg">
                                <img class="lazy" data-src="assets/images/process/style1/dryer.webp" alt="Images">
                            </div>
                            <div class="content-text">
                                <h4 class="title">Dryer </h4>
                                <p class="services-txt">Maintenance, repairs, and cleaning to keep dryers efficient.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 sm-mb-30">
                        <div class="services-item">
                            <div class="services-icon">
                                <img class="lazy" data-src="assets/images/process/style1/dishwasher.webp" alt="Images">
                            </div>
                            <div class="content-text">
                                <h4 class="title">Dishwasher</h4>
                                <p class="services-txt">Maintenance, repairs, and cleaning for efficient dishwashers.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 sm-mb-30">
                        <div class="services-item">
                            <div class="services-icon blue-icon-bg">
                                <img class="lazy" data-src="assets/images/process/style1/cooktop-oven.webp" alt="Images">
                            </div>
                            <div class="content-text">
                                <h4 class="title">Cooktop Oven </h4>
                                <p class="services-txt">Maintenance, repairs, and cleaning to ensure efficient cooktop
                                    ovens.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="services-item">
                            <div class="services-icon">
                                <img class="lazy" data-src="assets/images/process/style1/oven.webp" alt="Images">
                            </div>
                            <div class="content-text">
                                <h4 class="title">Oven </h4>
                                <p class="services-txt">Maintenance, repairs, and cleaning for efficient oven
                                    operation.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="services-item">
                            <div class="services-icon blue-icon-bg">
                                <img class="lazy" data-src="assets/images/process/style1/stove.webp" alt="Images">
                            </div>
                            <div class="content-text">
                                <h4 class="title">Stove </h4>
                                <p class="services-txt">Maintenance, repairs, and cleaning to ensure efficient stove
                                    operation.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 sm-mb-30">
                        <div class="services-item">
                            <div class="services-icon">
                                <img class="lazy" data-src="assets/images/process/style1/refrigerator.webp" alt="Images">
                            </div>
                            <div class="content-text">
                                <h4 class="title">Refrigerator</h4>
                                <p class="services-txt">Maintenance, repairs, and cleaning to keep refrigerators
                    ...
                    <div class="col-lg-3 col-md-6 sm-mb-30">
                        <div class="services-item">
                            <div class="services-icon blue-icon-bg">
                                <img class="lazy" data-src="assets/images/process/style1/microwave.webp" alt="Images">
                            </div>
                            <div class="content-text">
                                <h4 class="title">Microwave</h4>
                                <p class="services-txt">Maintenance, repairs, and cleaning to keep microwaves running
                                    efficiently.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="services-item">
                            <div class="services-icon">
                                <img class="lazy" data-src="assets/images/process/style1/WineHolder.webp" alt="Images">
                            </div>
                            <div class="content-text">
                                <h4 class="title">Wine cooler</h4>
                                <p class="services-txt">Maintenance, repairs, and cleaning for efficient wine cooler
                                    operation.</p>
                            </div>
                        </div>
                    </div>
        ...
        <section id="rs-project" class="rs-project project-style4 pt-120 pb-120 md-pt-80 md-pb-80">
            <div class="container">
                ...
                <div class="gridFilter mb-50 md-mb-30 text-center">
                    ...
                    <button data-filter=".filter1">Washing machine</button>
                    <button data-filter=".filter2">Refrigerator</button>
                    <button data-filter=".filter3">Oven</button>
                    <button data-filter=".filter4">Stove</button>
                </div>
                <div class="row grid">
                        ...
                        <div class="project-item">
                            ...
                            <div class="project-content">
                                <div class="project-inner">
                                    <span class="category"><a href="#">Electrician</a></span>
                                    <h3 class="title"><a href="#">Electrician</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-30 grid-item filter1">
                        <div class="project-item">
                            ...
                            <div class="project-content">
                                <div class="project-inner">
                                    <span class="category"><a href="#">Washing machine</a></span>
                                    <h3 class="title"><a href="#">Repair Washing machine</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 grid-item filter2">
                        <div class="project-item">
                            ...
                            <div class="project-content">
                                <div class="project-inner">
                                    <span class="category"><a href="#">Refrigerator</a></span>
                                    <h3 class="title"><a href="#">Repair Refrigerator</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 grid-item filter3">
                        <div class="project-item">
                            ...
                            <div class="project-content">
                                <div class="project-inner">
                                    <span class="category"><a href="#">Oven</a></span>
                                    <h3 class="title"><a href="#">Repair Oven</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-30 grid-item filter4">
                        <div class="project-item">
                            ...
                            <div class="project-content">
                                <div class="project-inner">
                                    <span class="category"><a href="#">Stove</a></span>
                                    <h3 class="title"><a href="#">Repair Stove</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="rs-testimonials"
            class="rs-testimonial testimonial-style2 testimonial-modify2 gray-bg3 pt-120 pb-120 md-pt-80 md-pb-80 sm-pb-40">
            <div class="container">
                <div class="sec-title text-center mb-45">
                    <span class="sub-text sub-text5">Reviews</span>
                    <h2 class="title">
                        Our clients reviews.
                    </h2>
                </div>
                <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30"
                    ...
                    <div class="testi-item">
                        <div class="item-content">
                            <span><img class="lazy" data-src="assets/images/testimonial/style1/quote4.webp" alt="Testimonial"></span>
                    ...
                    <div class="testi-item">
                        <div class="item-content">
                            ...
                            <p>"I had a problem with my fridge and called this appliance service company for help. They
                                ...
                                provided me with a clear explanation of the problem and the repair process. He even went
                                above and beyond by checking the rest of my fridge for any potential issues. The repair
                                was done in a timely manner, and my fridge is now working perfectly. I highly recommend
                                this company for their fast, reliable, and affordable service."</p>
                        </div>
                    </div>
                    <div class="testi-item">
                        <div class="item-content">
                            ...
                            <p>"I contacted the company to repair my oven, and I was extremely satisfied with the
                                ...
                                quote for the repair. The repair was done in a timely manner, and my oven is now working
                                like new. I was impressed with the quality of service and the fair pricing. I would
                                definitely recommend this company to anyone in need of appliance repairs."</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Partner Start -->
        <section class="rs-partner partner-main-home partner-modify5">
        ...
        <section id="rs-contact" class="rs-contact contact-style1 contact-modify1 pt-120 pb-120 md-pt-80 md-pb-80">
            <div class="container">
                <div class="row y-middle">
                    <div class="col-lg-6">
                        <div class="contact-map">
                            ...
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d48598.909248540396!2d-74.53702758734757!3d40.42143595626614!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c3c36b50e0b2f5%3A0x7ea334ea5a9d1443!2s2110%20Sugar%20Maple%20Ct%2C%20Monmouth%20Junction%2C%20NJ%2008852%2C%20USA!5e0!3m2!1sen!2saz!4v1682408804017!5m2!1sen!2saz"></iframe>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="contact-section">
                            <div class="contact-wrap">
                                <div class="sec-title mb-55 md-mb-40">
                                    <span class="sub-text sub-text5">
                                        Contact Us
                                    </span>
                                    <h2 class="title">
                                        Book a call
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 mb-30">
                                                <input class="from-control" type="text" id="names"
                                                    name="names" placeholder="Your Name">
                                                @error('names')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 mb-30">
                                                <input class="from-control" type="email" id="emails"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 mb-30">
                                                <input class="from-control" type="text" id="phones"
                                                    name="phones" placeholder="Phone" required="">
                                                @error('phones')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 mb-30">
                                                <select class="from-control" name="service" id="service-select">
                                                    ...
                                                    <option value="Cooktop Oven">Cooktop Oven</option>
                                            ...
                                            <div class="col-lg-12 mb-30">
                                                <textarea class="from-control" id="message" name="messages" placeholder="Message Here" required=""></textarea>
                                                @error('messages')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="btn-part">
                                            <div class="form-group mb-0">
                                                <input class="readon more submit submit-blue booking-btn"
