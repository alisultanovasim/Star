...
(function ($) {
  ...
  if (searchParent.length) {
    $(".search-parent").on("click", function () {
      $(this).addClass("open_add_class", 1000);
    });
    ...
    $(document).on("click", function (e) {
      if (
        ...
        searchParent.removeClass("open_add_class");
      }
    });
  }
...
// Get the menu items from the navigation menu
...
window.addEventListener('scroll', () => {
  ...
  sections.forEach((section) => {
    ...
    if (currentScrollPos >= sectionTop && currentScrollPos < sectionTop + sectionHeight) {
      ...
      // Loop through each menu item to update the class
